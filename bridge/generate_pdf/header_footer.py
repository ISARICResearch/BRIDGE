...
def set_paperlike_footer_content(canvas: Canvas, title: str):
    canvas.setFont("DejaVuSans", 8)
    canvas.drawString(
        0.4 * inch,
        0.45 * inch,
...
def draw_paperlike_page_number(canvas: Canvas, doc: SimpleDocTemplate):
...
def generate_paperlike_header_footer(
    canvas: Canvas, doc: SimpleDocTemplate, title: str
):
...
def set_completion_guide_footer_content(canvas: Canvas, title: str):
    canvas.setFont("DejaVuSans", 8)
    canvas.drawString(
        0.4 * inch,
        0.45 * inch,
...
def get_page_number_text(doc: SimpleDocTemplate, toc_pages: int) -> str:
...
def draw_completion_guide_page_number(
    canvas: Canvas, doc: SimpleDocTemplate, toc_pages: int
):
...
def generate_completion_guide_header_footer(
    canvas: Canvas, doc: SimpleDocTemplate, title: str, toc_pages: int = 0
):
