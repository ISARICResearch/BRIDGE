...
class Form:
    ...
    def _format_multi_choice_field(self,
                                   row: pd.Series,
                                   new_field: Field) -> Field | None:
    ...
    def _add_field_to_section(self,
                              row: pd.Series,
        ...
        # if units, add units to last field's answer
            ...
            formatted_choices = self.format_choices(row['Choices, Calculations, OR Slider Labels'], row['Field Type'],
                                                    200, True)
    ...
    def _get_sections(self,
        ...
        for index, row in group.iterrows():
            ...
            section_fields[current_section_index] = self._add_field_to_section(field_to_add,
