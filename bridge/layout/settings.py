...
class Settings:
    def __init__(self, arc_version_list, arc_language_list, version, language):
        ...
        self.arc_versions_items = [
            ...
            for i, version in enumerate(self.arc_version_list)
        ]
        self.arc_language_items = [
            dbc.DropdownMenuItem(language, id={"type": "dynamic-language", "index": i})
            for i, language in enumerate(self.arc_language_list)
        ]
                    ...
                    [
                        dbc.InputGroup(
                            [
                                ...
                                dbc.Input(
                                    id="dropdown-ARC_version_input", value=self.version
                                ),
                            ]
                        ),
                    ...
                    [
                        dbc.InputGroup(
                            [
                                ...
                                dbc.Input(
                                    id="dropdown-ARC_language_input",
                                    value=self.language,
                                ),
                            ]
                        ),
                ...
                html.Div(
                    [
                        ...
                        dbc.Checklist(
                            ...
                            options=[
                                {
                                    "label": "ISARIC Clinical Characterization XML",
                                    "value": "redcap_xml",
                                },
                                {
                                ...
                                {
                                    "label": "Paper-like CRF (PDF + Guide)",
                                    "value": "paper_like",
                                },
                                {
                                    "label": "CRF Review Word Document",
                                    "value": "paper_word",
                                },
                            ],
