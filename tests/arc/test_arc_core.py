...
def test_get_arc_versions(mock_get_versions,
    ...
    (version_list_output,
     latest_version_output) = arc_core.get_arc_versions()
...
def test_get_arc(mock_sha,
    ...
    (df_output,
     preset_output,
     commit_output) = arc_core.get_arc(version)
...
def test_get_include_not_show():
    ...
    df_output = arc_core.get_include_not_show(selected_variables,
                                              df_current_datadicc)
    assert_frame_equal(df_output, df_expected)


@mock.patch('bridge.arc.arc_core.set_select_units')
@mock.patch('bridge.arc.arc_core.extract_parenthesis_content', return_value='select units')
def test_get_select_units(mock_extract_parenthesis,
    ...
    (df_output,
     list_output) = arc_core.get_select_units(selected_variables,
                                              df_current_datadicc)
...
def test_add_transformed_rows():
    ...
    df_output = arc_core.add_transformed_rows(df_selected_variables,
