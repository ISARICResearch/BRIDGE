...
def test_on_save_click_no_action(
    n_clicks,
    checked_variables,
...
def test_on_save_click(mock_checked, mock_crf_name, mock_trigger_id, mock_date):
    ...
    assert (
        output[1]["content"]
        == "VmFyaWFibGUsVWxpc3QgU2VsZWN0ZWRfeCxVbGlzdCBTZWxlY3RlZF95CmluY2x1X2Rpc2Vhc2UsQWRlbm92aXJ1cyxBZGVub3ZpcnVzCg=="
    )
